...
var production = _gulpUtil2.default.env.production || process.env.NODE_ENV === 'production';
...
var config = {
    ...
    sourcemaps: !_gulpUtil2.default.env.production,
...
config.get = function (path) {
    ...
    return _path2.default.join(basePath, current);
};
